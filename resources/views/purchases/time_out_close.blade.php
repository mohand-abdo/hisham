...
@section('title','فواتيــر المشتريات التي اقترب موعد الاستحقاق')
    ...
    <div class="col-8">
        <div class="card shadow mb-4 ">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary" style="float:right">فواتير المشتريات التي اقترب موعد الاستحقاق</h6>
            </div>
            <div class="card-body">
        ...
        $('body').on('click','.sup_det',function(){
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#show-supplier .table-responsive').remove();
                    $('#show-supplier').append(data);
                }
            });
        });
