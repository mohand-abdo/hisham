...
@section('title','فواتير المبيعات التي اقترب موعد الاستحقاق')
    ...
    <div class="col-8">
        <div class="card shadow mb-4 ">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary" style="float:right">فواتير المبيعات التي اقترب موعد الاستحقاق</h6>
            </div>
            <div class="card-body">
                                ...
                                @foreach ($sales as $index => $sale)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="#" class="btn btn-info btn-sm rounded-circle cli_det" title="تفاصبل" data-url="{{ route('sale.client',$sale->id)}}" data-method="GET" data-original-title="{{__('dashboard.print')}}">
                                                <i class="fa fa-link"></i>
                                            </a>
                                            <a href="{{route('sale.print',$sale->id)}}" title="طباعة" class="btn btn-success btn-sm rounded-circle" data-toggle="tooltip" data-original-title="{{__('dashboard.print')}}">
